...
using wara3.test.Core.Models.Account;
using wara3.test.Core.Services;
using wara3.test.Core.Services.Account;
using wara3.test.Core.Services.Shop;
using wara3.test.Server.Authorization;
using wara3.test.Server.Authorization.Requirements;
using wara3.test.Server.Configuration;
using wara3.test.Server.Services;
using wara3.test.Server.Services.Email;
...
if (app.Environment.IsDevelopment())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.DocumentTitle = "Swagger UI - wara3.test";
