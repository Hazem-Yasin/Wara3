...
- Create Angular project with ng: `ng new wara3_fullstack_angular_.net.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`wara3_fullstack_angular_.net.client.esproj`).
